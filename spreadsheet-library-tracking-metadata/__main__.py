...
pulumi.export("shared_glue_role_arn", shared_glue_role_arn)  # Python print() equivalent
...
job_name = "spreadsheet-library-tracking-metadata"
...
base_name = "spreadsheet__library_tracking_metadata"
