...
BASE_NAME_DEFAULT = "spreadsheet__library_tracking_metadata"
S3_MID_PATH_DEFAULT = f"orcaglue/{BASE_NAME_DEFAULT}/dev"
SCHEMA_NAME = "tsa"
DB_NAME = "orcavault"

# Resolved at runtime in GlueLibraryTrackingMetadata constructor
BASE_NAME = None
S3_MID_PATH = None
OUT_NAME = None
OUT_NAME_DOT = None
...
def transform():
    ...
    for sheet in SHEETS:
        ...
        df = pl.read_csv(
            f"{OUT_PATH}__{sheet}.csv", infer_schema_length=False, infer_schema=False
        )
...
class GlueLibraryTrackingMetadata(Job):
    def __init__(self, glue_context: GlueContext):
        ...
        job_name = args.get("JOB_NAME", "GlueLibraryTrackingMetadata")
